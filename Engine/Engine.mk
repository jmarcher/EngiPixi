...
CXX      := /usr/bin/g++
CC       := /usr/bin/gcc
CXXFLAGS := -std=c++17 -O0 -Wall -lSDL2main -lSDL2 -lSDL2_image -lSDL2_image -lSDL2_ttf -g  $(Preprocessors)
...
$(IntermediateDirectory)/AssetManager.cpp$(ObjectSuffix): AssetManager.cpp $(IntermediateDirectory)/AssetManager.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/gordo/Code/C++/EngiPixi/Engine/AssetManager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/AssetManager.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ECS_ProjectileComponent.cpp$(ObjectSuffix): ECS/ProjectileComponent.cpp $(IntermediateDirectory)/ECS_ProjectileComponent.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/gordo/Code/C++/EngiPixi/Engine/ECS/ProjectileComponent.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ECS_ProjectileComponent.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ECS_UILabel.cpp$(ObjectSuffix): ECS/UILabel.cpp $(IntermediateDirectory)/ECS_UILabel.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/gordo/Code/C++/EngiPixi/Engine/ECS/UILabel.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ECS_UILabel.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ECS_PhysicsComponent.cpp$(ObjectSuffix): ECS/PhysicsComponent.cpp $(IntermediateDirectory)/ECS_PhysicsComponent.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/gordo/Code/C++/EngiPixi/Engine/ECS/PhysicsComponent.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ECS_PhysicsComponent.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Helpers_KeyboardHandler.cpp$(ObjectSuffix): Helpers/KeyboardHandler.cpp $(IntermediateDirectory)/Helpers_KeyboardHandler.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/gordo/Code/C++/EngiPixi/Engine/Helpers/KeyboardHandler.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Helpers_KeyboardHandler.cpp$(ObjectSuffix) $(IncludePath)
